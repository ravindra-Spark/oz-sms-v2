...
// import { Card, Page, BlockStack, Divider, useBreakpoints, Grid,Banner  } from "@shopify/polaris";
...
//       try {
//         const response = await fetch('https://beneficial-business-app.fly.dev/api/settings');
//         if (response.ok) {
...
//       const phoneNumbers = response.customers.flatMap(customer => 
//         customer.addresses.map(address => formatPhoneNumber(address.phone))
//       ).filter(phone => phone); // Filter out empty or null phone numbers
...
//     try {
//       const response = await fetch(`/api/customerBulk?startDate=${startDate}&endDate=${endDate}`);
//       if (!response.ok) {
...
//     const numbers = input.split(/,|\n/).map(number => number.trim()).filter(phone => phone); // Filter out empty numbers
...
//               </Grid.Cell>
//               <Grid.Cell columnSpan={{ xs: 6, sm: 4, md: 4, lg: 4, xl: 6 }}>
//                 <h1 style={{ margin: '20px 0px 0px 150px', fontSize: '18px' }}>Send Bulk SMS Customers</h1>
//                 <p style={{ margin: '20px 0px 0px 150px' }}>Here You can send bulk SMS campaigns to your customers' phones.</p>
//                 <p style={{ margin: '20px 0px 0px 150px' }}>Customers can be filtered based on the date they were created.</p>
//                 <button
//                   style={{
//                     padding: '10px 15px',
//                     display: 'block',
...
//                     backgroundColor: loadingFilterOrders ? '#cccccc' : '#3d91ff',
//                     color: '#fff',
//                     border: 'none',
//                     borderRadius: '4px',
//                     textDecoration: 'none'
